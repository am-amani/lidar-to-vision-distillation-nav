...
# Initialize the success and failure counters
sucess = 0
failer = 0
iter = 0
stuck = 0
...
while True:
    ...
    next_state, reward, env_done, target, _, _ = env.step(a_in)
    collision = bool(env_done and not target)
    done = env_done
