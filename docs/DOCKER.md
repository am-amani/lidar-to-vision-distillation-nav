...
The first build takes 10-20 minutes. On the `turtlebot3-waffle` branch use the
tag `drl-nav:waffle` instead.
...
Interactive shell: `docker run --rm -it drl-nav:pioneer`.
