...
This branch contains the **Pioneer 3-DX** simulation. The
[`turtlebot3-waffle`](../../tree/turtlebot3-waffle) branch contains the
TurtleBot3 Waffle version. Both use ROS Noetic and Gazebo 11 on Ubuntu 20.04.
...
- `catkin_ws/src/multi_robot_scenario`: Gazebo world, launch files and Pioneer
  description.
...
Place these files in `TD3/pytorch_models`:
